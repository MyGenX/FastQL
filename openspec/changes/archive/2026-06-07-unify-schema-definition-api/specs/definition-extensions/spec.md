...
The framework SHALL allow fields to declare ordered extension objects that wrap resolver execution and MAY be synchronous or asynchronous.
...
The framework SHALL allow fields to declare permission classes whose checks run before the resolver and whose failures become GraphQL field errors.

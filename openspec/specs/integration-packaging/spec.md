# integration-packaging Specification

## Purpose
Packaging and distribution rules for FastQL web-framework integrations, keeping the base install dependency-free while offering independent, optional framework extras with isolated imports and validated compatibility.
